...
Part 2: Create or re-familiarize yourself with a Reclaim Hosting account <https://reclaimhosting.com> (or another hosting account if you have one).
...
Part 4: Create or re-familiarize yourself with a GitHub account <https://github.com>. Then, 
...
**The assignment should be done by Thursday Sept. 10th.**
